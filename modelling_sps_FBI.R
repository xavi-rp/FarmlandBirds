...
sps <- c("Anthus pratensis",        # meadow pipit; EBBA2 area (central-north Eur, plus Georgia-Armenia) quite smaller than GBIF (whole Eur)
         "Emberiza citrinella",     # yellowhammer; EBBA2 area (central-east Eur, north third Iberian P) a bit smaller than GBIF (incl. whole Iber. Pen.)
         "Serinus serinus",      # European serin (Fringillidae); EBBA2 area (south-central Eur) similar to GBIF (also some occs in UK and N Scandin)
         "Upupa epops"       # Eurasian hoopoe (Puput); EBBA2 area (south-central-east Eur, no UK, Scandinavia and few in NL, BE and West-DE) a bit smaller than GBIF (whole Eur)
         )
